                ...
                <div class="row align-self-center">
                    ...
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="index.html"><img src="./public/images/logo/logo.png" alt="Site Logo" /></a>
                        </div>
                    </div>
                    <!-- Header Logo End -->
                                    ...
                                    <ul class="mega-menu d-block">
                                        ...
                                        <li>
                                            ...
                                            <ul class="menu-banner w-100">
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img class="img-responsive w-100" src="./public/images/banner/3.jpg" alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img class="img-responsive w-100" src="./public/images/banner/4.jpg" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
