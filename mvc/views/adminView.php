        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <a href="index.html" class="logo">
                    <img src="./publicAdmin/images/logo-light.png" class="logo-lg" alt="" height="22">
                    <img src="./publicAdmin/images/logo-sm.png" class="logo-sm" alt="" height="24">
                </a>
            </div>
                ...
                <ul class="navbar-right list-inline float-right mb-0">
                    ...
                    <li class="dropdown notification-list list-inline-item d-none d-md-inline-block">
                        <a class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="./publicAdmin/images/flags/us_flag.jpg" class="mr-2" height="12" alt="" /> English <span class="mdi mdi-chevron-down"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated language-switch">
                            <a class="dropdown-item" href="#"><img src="./publicAdmin/images/flags/french_flag.jpg" alt="" height="16" /><span> French </span></a>
                            <a class="dropdown-item" href="#"><img src="./publicAdmin/images/flags/spain_flag.jpg" alt="" height="16" /><span> Spanish </span></a>
                            <a class="dropdown-item" href="#"><img src="./publicAdmin/images/flags/russia_flag.jpg" alt="" height="16" /><span> Russian </span></a>
                            <a class="dropdown-item" href="#"><img src="./publicAdmin/images/flags/germany_flag.jpg" alt="" height="16" /><span> German </span></a>
                            <a class="dropdown-item" href="#"><img src="./publicAdmin/images/flags/italy_flag.jpg" alt="" height="16" /><span> Italian </span></a>
                        </div>
                    </li>
                    ...
                    <li class="dropdown notification-list list-inline-item">
                        <div class="dropdown notification-list nav-pro-img">
                            <a class="dropdown-toggle nav-link arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="./publicAdmin/images/users/user-1.jpg" alt="user" class="rounded-circle">
                            </a>
                                            ...
                                            <div class="p-2 mt-2">
                                                <ul class="list-unstyled latest-message-list mb-0">
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="./publicAdmin/images/users/user-2.jpg" alt="">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="./publicAdmin/images/users/user-3.jpg" alt="">
                                                                <div class="media-body">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="./publicAdmin/images/users/user-4.jpg" alt="">
                                                                <div class="media-body">
                                            ...
                                            <div class="p-2 mt-2">
                                                <ul class="list-unstyled latest-message-list mb-0">
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="./publicAdmin/images/users/user-5.jpg" alt="">
                                                                <div class="media-body">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="./publicAdmin/images/users/user-6.jpg" alt="">
                                                                <div class="media-body">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="./publicAdmin/images/users/user-7.jpg" alt="">
                                                                <div class="media-body">
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <img src="./publicAdmin/images/users/user-1.jpg" alt="" class="thumb-md rounded-circle mr-2"> Philip Smead</td>
                                                    <td>April, 25</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./publicAdmin/images/users/user-2.jpg" alt="" class="thumb-md rounded-circle mr-2"> Brent Shipley</td>
                                                    <td>April, 28</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./publicAdmin/images/users/user-3.jpg" alt="" class="thumb-md rounded-circle mr-2">Kevin Ashley</td>
                                                    <td>June, 12</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./publicAdmin/images/users/user-4.jpg" alt="" class="thumb-md rounded-circle mr-2">Martin Whitmer</td>
                                                    <td>June, 28</td>
                                                    <td><span class="badge badge-success">Medium</span></td>
                                                </tr>
                                                <!-- end 4 -->
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <img src="./publicAdmin/images/users/user-5.jpg" alt="" class="thumb-md rounded-circle mr-2"> Enrique Peters</td>
                                                    <td>July, 15</td>
                                                    <td><span class="badge badge-danger">Low</span></td>
                                                </tr>
                                                <!-- end 5 -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./publicAdmin/images/users/user-6.jpg" alt="" class="thumb-md rounded-circle mr-2"> Richard Schnell</td>
                                                    <td>July, 30</td>
                                                    <td><span class="badge badge-primary">High</span></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./publicAdmin/images/users/user-7.jpg" alt="" class="thumb-md rounded-circle mr-2">Dennis Jackson</td>
                                                    <td>August, 08</td>
                                                    <td><span class="badge badge-success">Medium</span></td>
                                                </tr>
                                                <!-- end 7 -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <img src="./publicAdmin/images/users/user-8.jpg" alt="" class="thumb-md rounded-circle mr-2">Carlos Rodrigues</td>
                                                    <td>August, 23</td>
                                                    <td><span class="badge badge-danger">Low</span></td>
                                                </tr>
